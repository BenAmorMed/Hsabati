...
import { X, Plus, Minus, Calendar, Tag, FileText, RefreshCcw } from 'lucide-react';
...
export const RecurringTransactionModal = ({ isOpen, onClose, onSuccess, token }: RecurringTransactionModalProps) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const apiUrl = process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5555';
            await axios.post(`${apiUrl}/recurring-transactions`, {
                type,
                ...
                <>
                    ...
                    >
                        ...
                        >
                            ...
                            <h2 className="text-xl md:text-2xl font-bold mb-6">Schedule <span className="gradient-text">Recurring</span></h2>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            <option value="yearly" className="bg-background">Yearly</option>
                                        </select>
                                    </div>
                                </div>
